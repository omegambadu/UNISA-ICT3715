...
public class MaskField extends TextField {
    ...
    /**
     * the position in the mask allows you to enter only numbers
     */
    public static final char MASK_DIGIT = 'D';

    /**
     * position in the mask allows you to enter letters and numbers
     */
    public static final char MASK_DIG_OR_CHAR = 'W';

    /**
     * the position in the mask allows you to enter only letters
     */
    ...
    /**
     * if the mask should display the characters that are reserved for the mask, then an additional hint is given where is the mask symbol and where is just the symbol
     */
    ...
    /**
     * these are substitution characters
     */
    ...
    /**
     * forms a list of Position objects for each symbol of the mask
     */
    private void rebuildObjectMask() {
        ...
        for (int i = 0; i < getMask().length(); i++) {
            ...
            if (getWhatMask() != null && i < getWhatMask().length()) {
                //mask symbol is specified or not
            ...
            {
                //since it is not indicated what kind of symbol - we understand independently
                // and if the character is not among the mask characters, then this is considered a simple literal
    ...
    /**
     *the function, as it were, simply imposes plainText text on the given mask,
     *      * adjusts the position of the carriage
     */
